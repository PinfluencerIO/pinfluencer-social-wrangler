...
namespace Pinfluencer.SocialWrangler.Tests.Unit.DL.SocialAudienceFacadeTests.GetAudienceCountryInsightsTests.Shared
{
    public abstract class When_Called : Given_A_SocialAudienceFacade
    {
